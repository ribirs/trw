...
const terrainHandlers = {
  ...
  'Farm': (x, y, data) => {
    ...
    if (Tog === 'Basic') {
      ...
      let costGold = 4500000;
      let costSteel = 4500;
      let costChip = 3500;
      let ReqLv = 70;
      let CostDark = 5;
      createActionButton('img/GeTher.webp', () => {
        if (Gold >= costGold && Steel >= costSteel && Chip >= costChip && Level >= ReqLv && Dark <= -CostDark ) {
          Gold -= costGold;
          Steel -= costSteel;
          Chip -= costChip;
          Energy += 350;
  ...
  'Farm1': (x, y, data) => {
    ...
    if (Tog === 'Basic') {
      ...
      createActionButton('img/Farm2.webp', () => {
        if (Gold >= costGold && Tree >= costTree && Rock >= costRock && Level >= ReqLv && Energy >= costEnergy) {
          Gold -= costGold;
          Tree -= costTree;
          Rock -= costRock;
          data.terrain = 'Farm2';
      ...
      createActionButton('img/Farm.webp', () => {
        if (Gold >= 5000) {Gold -= 5000;data.terrain = 'Farm';updateMenu(x, y);draw();
          FoodBox -= 100;
          FoodAmount -= 1;
        } else {showWarning(`${formatNumber(5000 - Gold)}골드 필요`, 0);}
      }, [{ current: Gold, required: 5000, icon: 'img/icon/Gold.webp' }]);
    }
  },
  ...
  'Rock1': (x, y, data) => {
    ...
    createActionButton('img/Rock2.webp', () => {
      if (Gold >= costGold && Tree >= costTree && Steel >= costSteel && Level >= ReqLv && Dark <= -CostDark && Energy >= costEnergy) {
        Gold -= costGold;
        Tree -= costTree;
        Steel -= costSteel;
        data.terrain = 'Rock2';
  ...
  'Rock2': (x, y, data) => {
    ...
    createActionButton('img/Rock3.webp', () => {
      if (Gold >= costGold && Tree >= costTree && Food >= costFood && Rock >= costRock && Steel >= costSteel && Level >= ReqLv && Dark <= -CostDark && Energy >= costEnergy) {
        Gold -= costGold;
        Tree -= costTree;
        Food -= costFood;
        Rock -= costRock;
  ...
  'Iron2': (x, y, data) => {
    ...
    createActionButton('img/Iron3.webp', () => {
      if (Gold >= costGold && Steel >= costSteel && Chip >= costChip && Uranium >= costUranium && Level >= ReqLv && Dark <= -CostDark && Energy >= costEnergy) {
        Gold -= costGold;
        Steel -= costSteel;
        Chip -= costChip;
        Uranium -= costUranium;
  ...
  'Chip': (x, y, data) => {
    ...
    if (Tog === 'Basic') {
      ...
      createActionButton('img/Chip1.webp', () => {
        if (Gold >= costGold && Tree >= costTree && Rock >= costRock && Steel >= costSteel && Level >= ReqLv && Dark <= -CostDark && Energy >= costEnergy) {
          Gold -= costGold;
          Tree -= costTree;
          Rock -= costRock;
          Steel -= costSteel;
  ...
  'Chip1': (x, y, data) => {
    ...
    createActionButton('img/Chip2.webp', () => {
      if (Gold >= costGold && Steel >= costSteel && Chip >= costChip && Oil >= costOil && Level >= ReqLv && Dark <= -CostDark && Energy >= costEnergy) {
        Gold -= costGold;
        Steel -= costSteel;
        Chip -= costChip;
        Oil -= costOil;
  ...
  'Oil': (x, y, data) => {
    ...
    if (Tog === 'Basic') {
      ...
      createActionButton('img/Oil1.webp', () => {
        if (Gold >= costGold && Steel >= costSteel && Chip >= costChip && Level >= ReqLv && Dark <= -CostDark && Energy >= costEnergy) {
          Gold -= costGold;
          Steel -= costSteel;
          Chip -= costChip;
          data.terrain = 'Oil1';
  ...
  'Oil1': (x, y, data) => {
    ...
    createActionButton('img/Oil2.webp', () => {
      if (
        ...
        Oil >= costOil &&
        Uranium >= costUranium &&
        Level >= ReqLv && Dark <= -CostDark && Energy >= costEnergy
      ) {
        Gold -= costGold;
        Steel -= costSteel;
        Chip -= costChip;
  ...
  'Gem': (x, y, data) => {
    ...
    const ReqLv = 80;
    const costEnergy = 200;
    const CostDark = 50;
    createActionButton('img/Gem1.webp', () => {
      if (Gold >= costGold && Chip >= costChip && Oil >= costOil && Uranium >= costUranium && Level >= ReqLv && Dark <= -CostDark && Energy >= costEnergy) {
        Gold -= costGold;
        Chip -= costChip;
        Oil -= costOil;
        Uranium -= costUranium;
  ...
  'Gem1': (x, y, data) => {
    ...
    const ReqLv = 100;
    const costEnergy = 500;
    const CostDark = 350;
    createActionButton('img/Gem2.webp', () => {
      if (Gold >= costGold && Oil >= costOil && Uranium >= costUranium && Level >= ReqLv && Dark <= -CostDark && Energy >= costEnergy) {
        Gold -= costGold;
        Oil -= costOil;
        Uranium -= costUranium;
        data.terrain = 'Gem2';
  ...
  'Grass': (x, y, data) => {
    ...
    if (Tog === 'Basic') {
      ...
      createActionButton('img/GeCoal.webp', () => {
        if (Gold >= costGold && Tree >= costTree && Rock >= costRock && Level >= ReqLv && Dark <= -CostDark) {
          Gold -= costGold;
          Tree -= costTree;
          Rock -= costRock;
          Energy += 150;
        ...
        createActionButton('img/Water.webp', () => {
          if (Gold >= costGold && Level >= 10) {
            ...
            const parts = [];
            if (Gold < costGold) parts.push(`${formatNumber(costGold - Gold)}골드`);
            if (Level < 10) parts.push(`레벨 ${formatNumber(10 - Level)}`);
            showWarning(parts.join(', ') + ' 필요',0);
          }
        }, [
          { current: Gold, required: costGold, icon: 'img/icon/Gold.webp' },
          { current: Level, required: 10, icon: 'img/icon/Up.png' },
          { current: 1, required: 0, icon: 'img/icon/Dark.webp' }
        ]);
    }
  },
  ...
  'Tree2': (x, y, data) => {
    ...
    if (Tog === 'Basic') {
      ...
      createActionButton('img/Tree1.webp', () => {
        if (Gold >= 10000) {Gold -= 10000;data.terrain = 'Tree1';updateMenu(x, y);draw();
          TreeBox -= 200;
          TreeAmount -= 2;
          GoldBonus -= 1;
          Dark += 2;
        } else {showWarning(`${formatNumber(10000 - Gold)}골드 필요`, 0);}
      }, [{ current: Gold, required: 10000, icon: 'img/icon/Gold.webp' }]);
    }
  },
  ...
  'Water': (x, y, data) => {
    ...
    if (Tog === 'Basic') {
      ...
      createActionButton('img/Fish1.webp', () => {
        ...
        let costGold = 200000;
        createActionButton('img/Hill.webp', () => {
          if (Gold >= costGold && Level >= 40) {
            Gold -= costGold;
            data.terrain = 'Hill';
            updateMenu(x, y);
            draw();
            ...
            const parts = [];
            if (Gold < costGold) parts.push(`${formatNumber(costGold - Gold)}골드`);
            if (Level < 40) parts.push(`레벨 ${formatNumber(40 - Level)}`);
            showWarning(parts.join(', ') + ' 필요',0);
          }
        }, [
          { current: Gold, required: costGold, icon: 'img/icon/Gold.webp' },
          { current: Level, required: 40, icon: 'img/icon/Up.png' }
        ]);
    } else if (Tog === 'Gene') {
      let costGold = 92000;
      let ReqLv = 25;
  ...
  'River1': (x, y, data) => {
    ...
    createActionButton('img/River2.webp', () => {
      ...
      { current: Level, required: ReqLv, icon: 'img/icon/Up.png' },
      { current: 10, required: 0, icon: 'img/icon/Energy.webp' },
      { current: 25, required: 0, icon: 'img/icon/Dark.webp' }
    ]);
  },
  ...
  'Gold1': (x, y, data) => {
    ...
    createActionButton('img/Gold2.webp', () => {
      if (Gold >= costGold && Level >= reqLevel && Dark <= -CostDark && Energy >= costEnergy) {
        Gold -= costGold;
        data.terrain = 'Gold2';
        GoldMine += 4000;
        Energy -= costEnergy;
  ...
  'Town': (x, y, data) => {
    const costg = getLevelRequirement(data.TownLevel);
    // const costg = Math.floor(100 * Math.pow(data.TownLevel, 1.3));
    createActionButton('img/icon/Up.png', () => {
      if (Gold >= costg && Level > data.TownLevel) {
        Gold -= costg;
        data.TownLevel++;
        if (data.TownLevel < 10) {
          Energy += 1;
        } else if (data.TownLevel < 20) {
          Energy += 2;
          Dark -= 1;
        } else if (data.TownLevel < 30) {
          Energy += 3;
          Dark -= 2;
        } else if (data.TownLevel < 40) {
          Energy += 4;
          Dark -= 3;
        } else if (data.TownLevel < 50) {
          Energy += 5;
          Dark -= 4;
        } else if (data.TownLevel < 60) {
          Energy += 6;
          Dark -= 5;
        } else {
          Energy += 7;
...
function updateMenu(x, y) {
  ...
  if (data?.purified > 0) {
    ...
    const terrainLabels = {
      ...
      Gold: '금광맥',Gold1: '금광산(골드+1000)',Gold2: '고급 금광산(골드+5000)',
      Gold3: '놀라운 금광산(골드+15000)',Gold4: '프리미엄 금광산(골드+45000)',
